...
label_input = Label(frame_input, text='Digite a URL:', bg='ghostwhite', fg='black',
                    font=('Times', 16, 'bold'))
label_input.place(relx=0.1, rely=0.2, relheight=0.08)
text = Entry(frame_input, font='Century 12')
text.place(relx=0.1, rely=0.33, relwidth=0.7, relheight=0.15)

# input for the location to save the QR
frame_loc = Frame(wn, bg='ghostwhite')
frame_loc.place(relx=0.15, rely=0.35, relwidth=0.7, relheight=0.2)

label_loc = Label(frame_loc, text='Onde salvar: ', bg='ghostwhite', fg='black',
                  font=('Times', 16, 'bold'))
label_loc.place(relx=-0.12, rely=0.08, relwidth=0.7, relheight=0.2)

loc = Entry(frame_loc, font='Century 12')
loc.place(relx=0.1, rely=0.3, relwidth=0.7, relheight=0.3)
